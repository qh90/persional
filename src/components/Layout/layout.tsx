...
export default function Layout({ children }: Props) {
  ...
  const title = currentPage?.metadata.title || "Rocky Harris";
  const description =
    currentPage?.metadata.description || "Rocky Harris Personal Website";

  return (
    <>
      <Head>
        <title>{currentPage?.metadata.title || "Rocky Harris"}</title>
